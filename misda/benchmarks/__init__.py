...
problems, clean ground-truth helpers, historical generator names, reproducible
classical DTLZ references, and evaluation summary utilities.
"""
...
from .classical import CLASSICAL_MOPS, generate_dtlz2, generate_dtlz5
