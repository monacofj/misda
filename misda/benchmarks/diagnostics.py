...
The historical ``Case``/``MOP`` generator names remain only as regression
fixtures. The public R5 diagnostic catalogue is one ordered sequence of thirteen
cases, named by the structural phenomenon under study. Stable scenario ids are
kept independent of those display labels.
...
infer structural dimension or structural units. The transitive positive chain
(one cumulative family but 20 structural units) and trade-off with redundant
families (three functional families but no unambiguous structural partition)
...
class DiagnosticScenario:
    ...
    @property
    def name(self) -> str:
        """Canonical public display name; ``historical_name`` is kept for compatibility."""
...
DIAGNOSTIC_SCENARIOS = (
    DiagnosticScenario(
        id="independence",
        historical_name="Case 1 - Independent objectives",
    ...
    DiagnosticScenario(
        id="total_redundancy",
        historical_name="Case 2 - Complete positive redundancy",
    ...
    DiagnosticScenario(
        id="blocks_4x5",
        historical_name="Case 3 - Four redundant blocks",
    ...
    DiagnosticScenario(
        id="blocks_2x10",
        historical_name="Case 4 - Two redundant blocks",
    ...
    DiagnosticScenario(
        ...
        historical_name="Case 5 - Mixed independent and redundant objectives",
    ...
    DiagnosticScenario(
        ...
        historical_name="Case 6 - Nonlinear monotonic redundancy",
    ...
    DiagnosticScenario(
        ...
        historical_name="Case 7 - Antagonistic linear groups",
    ...
    DiagnosticScenario(
        ...
        historical_name="Case 8 - Trade-off with redundant families",
    ...
    DiagnosticScenario(
        ...
        historical_name="Case 9 - Nonlinear redundant blocks",
    ...
    DiagnosticScenario(
        ...
        historical_name="Case 10 - Antagonistic nonlinear groups",
    ...
    DiagnosticScenario(
        ...
        historical_name="Case 11 - Overlapping latent factors",
    ...
    DiagnosticScenario(
        id="transitive_chain",
        historical_name="Case 12 - Transitive positive chain",
    ...
    DiagnosticScenario(
        id="regime_switching",
        historical_name="Case 13 - Regime-switching dependence",
